!function(t) {
    "use strict";
    var s = function(s, o) {
        this.el = t(s), this.options = t.extend({}, t.fn.typed.defaults, o), this.isInput = this.el.is("input"), 
    ...
    s.prototype = {
        ...
        typewrite: function(t, s) {
            if (this.stop !== !0) {
                ...
                e.timeout = setTimeout(function() {
                    ...
                    e.timeout = setTimeout(function() {
                        if (s === t.length) {
                            if (e.options.onStringTyped(e.arrayPos), e.arrayPos === e.strings.length - 1 && (e.options.callback(), 
        ...
        strings: [ "HELLO", "NELLO","Have a great day!" ],
        typeSpeed: 0,
        startDelay: 0,
        backSpeed: 0,
        backDelay: 500,
